...
---
*Last updated: 2026-09-12 (landing-evidence triage run 1) — first operational run of the landing-evidence triage against the live repo: of 6 open `devagent/TASK-*` PRs, 4 zombies closed — #305 and #334 as `superseded` (cited issues #292 and #275 are closed with no `(#N)` landing commit on main, "not shipped"), #307 and #309 as `shipped-elsewhere` (cited issues #293 and #306 closed, landing commits 8bc9618 and 8eea971 cited in the close comments); #314 and #318 stayed open (green, no closed-issue citation). Every close carries the standard sweep comment and one apply-mode ledger row (internal/orchestrator/pr-hygiene.go).
